...
export const PHANTOM_LEVEL_CONTENT: Record<number, PhantomLevelContent> = {
  ...
  13: { tier: "act2", goal: "Install three stealthy persistence mechanisms: a loader hook, an authentication backdoor, and a shell alias trap.", realWorldSkill: "Stealthy persistence that evades basic security audits.", mitigationVersion: "2026-04" },
