...
export async function PhantomCertificate({ cert }: { cert: TrackCertificate }) {
  ...
  return (
    <article
      ...
      className="border-2 border-red bg-bg text-text font-mono p-4 sm:p-8 max-w-3xl mx-auto shadow-[0_0_30px_rgba(239,68,68,0.2)] overflow-hidden"
    >
      <div className="text-center space-y-1">
        ...
        {/* Wrapper div has overflow-x-auto so the inline-block pre can
            ...
            article wider than the viewport (Fafikk 2026-05-03 mobile
            scroll fix). Inline styles still survive html-to-image's
            DOM-clone step. */}
        <div className="overflow-x-auto -mx-4 sm:mx-0 px-4 sm:px-0">
          <pre
            ...
            className="font-mono text-red text-[10px] select-none"
          >
...
|_|   |_| |_/_/   \\_\\_| \\_| |_| \\___/|_|  |_|
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-6 items-start">
        <div className="space-y-4 min-w-0">
          ...
          <h1 className="text-2xl sm:text-3xl text-red tracking-wide break-all">
            @{cert.username}
          </h1>
