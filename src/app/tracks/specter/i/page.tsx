...
export default async function SpecterIPage() {
  ...
  return (
    <div className="space-y-12 max-w-3xl">
      ...
      <section className="space-y-3 border border-amber p-4">
        <h2 className="text-amber text-lg">Status</h2>
        <p className="text-sm">
          L0 is in internal testing. L1 is in build. L2 through L13 are queued
          behind a level-by-level test cycle — every level passes a 27-class
          security pre-audit, internal play-through, and adversarial cheat-
          probing before it ships. We are not running an early-access drip.
        </p>
        <p className="text-sm text-muted">
          The full sub-track ships when L0 through L13 are all proven. No
          one logs in to half a course.
        </p>
      </section>
      ...
      <footer className="border-t border-border pt-4 space-y-2">
        <p className="text-sm">
          ...
          to be notified the moment Specter I opens.
        </p>
